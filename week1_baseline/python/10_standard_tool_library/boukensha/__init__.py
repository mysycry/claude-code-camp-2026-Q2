...
def run(task, system=None, model=None, backend=None, api_key=None,
        ...
        working_dir=None, allowed_commands=None, shell_timeout=30, mud=None, *, block=None):
    cfg = _get_config()
...
__all__ = [
    ...
    "OllamaCloud", "OpenAI", "OpenCode", "PromptBuilder", "Registry", "Repl", "RunDSL",
    "TaskBase", "TaskPlayer", "Tool", "VERSION", "ApiError", "LoopError", "UnknownToolError", "UnsupportedModelError",
