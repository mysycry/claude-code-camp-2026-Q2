...
registry.tool(
    ...
    block=lambda path: open(os.path.normpath(os.path.join(base_dir, "..", "..", "ruby", "05_agent_loop", path))).read(),
)
...
registry.tool(
    ...
    block=lambda path: ", ".join(f for f in os.listdir(os.path.normpath(os.path.join(base_dir, "..", "..", "ruby", "05_agent_loop", path))) if not f.startswith(".")),
)
